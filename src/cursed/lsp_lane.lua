...
while ss:running() do
    ...
    local events, n = lsp_kq:wait(ss:has_overflow(ss._ptr.inboxes[constants.LANE_IDX_LSP]) and 10 or 1000)
    for i = 0, n - 1 do
        local ev = events[i]
    ...
    ss:flush_overflow(ss._ptr.inboxes[constants.LANE_IDX_LSP])
end
